...
- A fasta file with the reference information.
...
To select a subsection of the alignment you have two options.
...
or powerpoint.  As an example, we'll look at one window where a "C" in the reference has been emitted as a "CC" 
in consensus^[This is almost certainly because this ZMW had a C channel SNR of 1.85, while beneath the default threshold and outside of the range for which the consensus model is accurate.].
